...
<!-- Might want to consider using the interactive one in this intro paragraph, as a hook. Maybe the hexagon example from the extended demo... cuz it's awesome. Food for thought.  -->
...
<!-- Added the above `const PATTERNS` because i wasn't seeing numbers in my codepen embed. -->
